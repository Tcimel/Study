...
[파일 경로]
Lv 1 : 
> ch2-calculator/calculator/v1
> https://github.com/Tcimel/Study/tree/ch2-calculator/src/calculator/v1

Lv 2 :
> ch2-calculator/calculator/v2
> https://github.com/Tcimel/Study/tree/ch2-calculator/src/calculator/v2
------------------------------------------------------------------------------------------
[상세 내용] 
Lv 1. 클래스 없이 기본적인 연산을 수행할 수 있는 계산기 만들기
[ ] 양의 정수(0 포함)를 입력받기
