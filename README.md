...
### Lv 5: 캡슐화 적용하기
### Lv 6: 도전 기능 가이드 (장바구니 및 구매하기 기능 추가, Enum, 람다&스트림을 활용한 주문 및 장바구니 관리)

## 📂 파일 경로

### Lv 2 경로: `ch2-kiosk/v2` : [GitHub 링크](https://github.com/Tcimel/Study/tree/ch2-kiosk/src/kiosk/lv2)

### Lv 3 경로: `ch2-kiosk/v3` : [GitHub 링크](https://github.com/Tcimel/Study/tree/ch2-kiosk/src/kiosk/lv3)

### Lv 4 경로: `ch2-kiosk/v4` : [GitHub 링크](https://github.com/Tcimel/Study/tree/ch2-kiosk/src/kiosk/lv4)

### Lv 5 경로: `ch2-kiosk/v5` : [GitHub 링크](https://github.com/Tcimel/Study/tree/ch2-kiosk/src/kiosk/lv5)

### Lv 6 경로: `ch2-kiosk/v6` : [GitHub 링크](https://github.com/Tcimel/Study/tree/ch2-kiosk/src/kiosk/lv6)
...
## 📌 Lv 3: 객체 지향 설계를 적용해 햄버거 메뉴를 클래스로 관리하기
...
## 📌 Lv 6. 도전 - Lv 1. 장바구니 및 구매하기 기능을 추가하기
- **장바구니 생성 및 관리 기능**
...
## 📌 Lv 6. 도전 - Lv 2. Enum, 람다 & 스트림을 활용한 주문 및 장바구니 관리 
